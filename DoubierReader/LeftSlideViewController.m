...
//  DoubierReader
//
//  Created by Zhixue Li on 12/9/15.
...
//    NSLog(@"%f %f %f %f", self.mainVC.view.bounds.origin.x, self.mainVC.view.bounds.origin.y, self.mainVC.view.bounds.size.width, self.mainVC.view.bounds.size.height);
}
